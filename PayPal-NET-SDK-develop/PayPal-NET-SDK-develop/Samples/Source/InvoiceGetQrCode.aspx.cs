...
{
    public partial class InvoiceGetQrCode : BaseSamplePage
    {
        protected override void RunSample()
        {
            ...
            // ^ Ignore workflow code segment
            #region Track Workflow
            this.flow.AddNewRequest("Retrieve a QR code");
            #endregion
            ...
            // ^ Ignore workflow code segment
            #region Track Workflow
            this.flow.RecordResponse(qrCode);
            this.flow.RecordImage(qrCode);
            #endregion
