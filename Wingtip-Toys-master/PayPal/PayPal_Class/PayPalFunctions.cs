...
public class NVPAPICaller
{
	...
	public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
	{
		...
		string returnURL = "http://localhost:55056/CheckoutReview.aspx";
		string cancelURL = "http://localhost:55056/CheckoutCancel.aspx";
		...
		for (int i = 0; i < myOrderList.Count; i++)
		{
			...
			encoder["L_PAYMENTREQUEST_0_AMT" + i] = myOrderList[i].UnitPrice.ToString();
	...
	public string HttpCall(string NvpRequest)
	{
		...
		{
			// Log the exception.
			PayPal.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
		}
